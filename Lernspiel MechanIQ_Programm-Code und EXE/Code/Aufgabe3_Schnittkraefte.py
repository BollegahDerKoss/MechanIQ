...
class Aufgabe3_Schnittkraefte:
    ...
    def __init__(self, master=None):
        ...
        self.aufgabe = AufgabeSchnittkraefte("Wähle das korrekte Freikörperbild!", "B")

        self.master = master
        self.Aufg3_SchnittGUI = tk.Toplevel(master)
        self.Aufg3_SchnittGUI.resizable(False, False)
        self.Aufg3_SchnittGUI.title("Level 3.1 - Schnittkraefte")
        self.Aufg3_SchnittGUI.geometry("1280x720")
        ...
        self.canvas = tk.Canvas(self.Aufg3_SchnittGUI, width=1280, height=720, highlightthickness=0)
        ...
        self.canvas.create_text(830, 30, text="Level 3.1 - Freikörperbild", font=("Helvetica", 18, "bold"), fill="black")
        ...
        self.bildAufgabe = Image.open("SK3_Aufgabenstellung.png")
        ...
        # Button Menü
        self.btnBackToMenu = tk.Button(self.Aufg3_SchnittGUI, text="Menü", command=self.backToMenu, font=("Verdana", 12, "bold"), bg="white")
        ...
        for name in ["a", "b", "c"]:
            try:
                img = Image.open(f"SK3_Antwort_{name}.png").resize((200, 150))
        ...
        for i, name in enumerate(["A", "B", "C"]):
            if self.bilder[name]:
                btn = tk.Button(self.Aufg3_SchnittGUI, image=self.bilder[name], command=lambda n=name: self.pruefe_aufgabe(n))
    ...
    def oeffneAufgabeGleichgewichte(self):
        Aufgabe3_Gleichgewichte(master=self.master)
        self.Aufg3_SchnittGUI.withdraw()

    def backToMenu(self):
        self.Aufg3_SchnittGUI.destroy()
        if self.master:
    ...
    def chatfenster_hinzufuegen(self, verlauf=""):
        ...
        self.chat_frame = tk.Frame(self.Aufg3_SchnittGUI, bg="#7b4be6", bd=1, relief=tk.GROOVE)
