...
class Aufgabe2_Gleichgewichte:

    def __init__(self, master=None):

        self.aufgabe = AufgabeGleichgewichte("none", "none", "(F1*a) - (F2*b)")

        self.master = master # ← speichert das letzte Fenster (Schnittkräfte)

        self.Aufg2_GleichGUI = tk.Toplevel(master)
        self.Aufg2_GleichGUI.resizable(False, False)
        self.Aufg2_GleichGUI.title("Level 2.2 - Gleichgewichte")
        self.Aufg2_GleichGUI.geometry("1280x720")  # Diese Fenstergröße passt für alle Bildschirme ab 13"
        ...
        self.canvas = tk.Canvas(self.Aufg2_GleichGUI, width=1280, height=720, highlightthickness=0)
        ...
        self.bildAufgabe = Image.open("GL2_Aufgabenstellung.png").resize((700, 400))
        ...
        self.canvas.create_text(830, 30, text="Level 2.2 - Gleichgewichte", font=("Helvetica", 18, "bold"), fill="black")
        ...
        self.eingabeM = tk.Entry(self.Aufg2_GleichGUI, width=30, font=("Arial", 16))
        self.eingabeM.place(relx=0.56, rely=640 / 720)

        self.btnM = tk.Button(self.Aufg2_GleichGUI, text="Absenden", command=self.checkLoesungM)
        self.btnM.place(relx=0.85, rely=640 / 720)

        self.ergebnisLabelM = tk.Label(self.Aufg2_GleichGUI, text="", font=("Arial", 12), bg="#ffffff")
        self.ergebnisLabelM.place(relx=0.56, rely=670 / 720)

        self.btnBackToMenu = tk.Button(self.Aufg2_GleichGUI, text="Menü", command=self.backToMenu, font=("Verdana", 12, "bold"), bg="white")
    ...
    def backToMenu(self):
            self.Aufg2_GleichGUI.destroy()  # Aufgabe-Fenster schließen
    ...
    def chatfenster_hinzufuegen(self, verlauf=""):
        ...
        self.chat_frame = tk.Frame(self.Aufg2_GleichGUI, bg="#7b4be6", bd=1, relief=tk.GROOVE)
